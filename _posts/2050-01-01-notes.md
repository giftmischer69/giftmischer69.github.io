...
title:  "notes"
categories: [📝]
permalink: temp-notes
---

https://de.wikipedia.org/wiki/Progressive_Web_App
https://www.google.com/search?q=progressive+web+app+quick+start&oq=progressive+web+app+quick+start&aqs=chrome..69i57.7190j0j7&sourceid=chrome&ie=UTF-8

---

# todo: write new

## old vertex-p2p manifest
